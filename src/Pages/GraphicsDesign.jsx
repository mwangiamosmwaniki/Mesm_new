...
import { Palette, Image, Layout, Printer, Smartphone, Globe } from "lucide-react";
...
export default function GraphicsDesign() {
  const services = [
    {
      ...
      description: "Create a strong visual identity that represents your brand's values and personality.",
      features: ["Logo Design", "Brand Guidelines", "Color Schemes", "Typography Selection"]
    },
    {
      icon: Globe,
      title: "Web Design",
      description: "Modern, responsive web designs that engage visitors and drive conversions.",
      features: ["Website Design", "UI/UX Design", "Landing Pages", "E-commerce Design"]
    },
    {
      icon: Printer,
      title: "Print Design",
    ...
    },
    {
      ...
      description: "Eye-catching graphics for your digital marketing campaigns and social media.",
      features: ["Social Media Graphics", "Ad Banners", "Email Templates", "Infographics"]
    },
    {
      icon: Layout,
      title: "Publication Design",
      description: "Professional layouts for magazines, books, reports, and other publications.",
      features: ["Magazine Layout", "Book Design", "Annual Reports", "Catalogs"]
    },
    {
      icon: Image,
      title: "Illustration & Graphics",
      description: "Custom illustrations and graphics that bring your ideas to visual life.",
      features: ["Custom Illustrations", "Icon Design", "Character Design", "Vector Graphics"]
    }
  ];
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      {/* Hero Section */}
      <section className="bg-gradient-to-br from-pink-900 to-purple-800 text-white py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <p className="text-xl text-pink-100 max-w-3xl mx-auto mb-8">
              Transform your ideas into stunning visual designs that capture attention, 
              communicate effectively, and leave a lasting impact on your audience.
            </p>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              We follow a structured design process to ensure every project meets 
              your expectations and delivers exceptional results.
            </p>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <h3 className="text-xl font-bold text-gray-900 mb-2">300+ Designs</h3>
              <p className="text-gray-600">
                Created over 300 unique designs across various industries 
                and project types.
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <h3 className="text-xl font-bold text-gray-900 mb-2">150+ Brands</h3>
              <p className="text-gray-600">
                Helped over 150 brands establish their visual identity 
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600">
                Achieved 100% client satisfaction through our commitment 
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <a href="mailto:info@mesmcompany.com">
              <Button size="lg" variant="outline" className="border-white text-white hover:bg-white hover:text-pink-900">
                View Portfolio
              </Button>
            </a>
          </div>
